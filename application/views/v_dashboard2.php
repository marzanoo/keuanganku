          ...
          <div class="row">
            ...
            <script>
                ...
                function fetchSaldo(filter) {
                    fetch('<?= base_url("Dashboard2/hitung_saldo") ?>', {
                        method: 'POST',
                        headers: {
            ...
            <script>
              ...
              function fetchPenerimaan(filter) {
                  fetch('<?= base_url("Dashboard2/hitung_penerimaan") ?>', {
                      method: 'POST',
                      headers: {
                          'Content-Type': 'application/json'
                      },
            ...
            <script>
              ...
              function fetchPengeluaran(filter) {
                  fetch('<?= base_url("Dashboard2/hitung_pengeluaran") ?>', {
                      method: 'POST',
                      headers: {
                          'Content-Type': 'application/json'
                      },
        ...
        <div class="col-lg-6">
          ...
          <div class="card">
              ...
              <div class="card-body pb-0">
                  <h5 class="card-title">Alokasi Pengeluaran <span id="filterText">| Hari ini</span></h5>
                  ...
                  <script>
                      document.addEventListener("DOMContentLoaded", () => {
                          ...
                          const filterText = document.querySelector("#filterText"); // Elemen teks filter
                          const alokasiData = <?= json_encode($alokasi_pengeluaran) ?>;

                          // Format data untuk chart
                          const chartData = alokasiData.map(item => ({
                              value: item.value,
                              name: item.output // Menampilkan kolom output sebagai nama
                          }));
                          ...
                          // Memuat data default untuk "Hari ini"
                          fetchFilteredData('hari_ini');

                          // Tambahkan event listener ke setiap filter
                          ...
                          function fetchFilteredData(filter) {
                              fetch('<?= base_url("Dashboard2/getFilteredData") ?>', {
                                  method: 'POST',
                                  headers: {
                                      'Content-Type': 'application/json'
                                  },
                              ...
                              .then(data => {
                                  ...
                                  const chart = echarts.getInstanceByDom(document.querySelector("#trafficChart"));
                                  chart.setOption({
                                      series: [{
                                          data: chartData
                                      }]
